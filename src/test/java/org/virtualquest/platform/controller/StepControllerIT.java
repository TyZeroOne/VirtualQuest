...
class StepControllerIT {
    ...
    @Test
    void createStep_ValidData() throws Exception {
        ...
        mockMvc.perform(post("/api/steps/quest/" + quest.getId())
                        .contentType("application/json")
                        .content("{\"description\":\"Start here\"}"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.description").value("Start here"));
    }
}